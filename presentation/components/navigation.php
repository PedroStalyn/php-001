...
<div class="container mx-auto flex justify-between items-center">
    <div class="flex items-center">
        <h1 class="text-white text-xl font-bold">MiniMarket Eimy - Administrador</h1>
    </div>
    <div class="flex items-center">
        <a href="../administrator/OptionsList.php" class="text-white hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium">
